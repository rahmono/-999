...
const LoginScreen: React.FC = () => {
  ...
  return (
    <div className="flex flex-col min-h-full bg-white dark:bg-gray-900 p-8 transition-colors pb-[safe-bottom]">
      ...
      <div className="pt-6 pb-2 flex justify-center">
        <button 
          ...
          className="text-sm text-gray-400 hover:text-blue-600 dark:text-gray-600 dark:hover:text-blue-400 flex items-center gap-2 transition-colors font-medium p-2"
        >
